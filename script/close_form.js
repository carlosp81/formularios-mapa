...
function openForm() {
  let form_element = document.querySelector(".show-form__busqueda_geodata");
  let search_form = document.querySelector(".form-box-busqueda");


  // console.log('FormEle', form_element);
  // console.log('FormEle', search_form);

  if (search_form === null) {

    let tempDiv = document.createElement("div");
    form_element.insertAdjacentElement("beforebegin", tempDiv);
    tempDiv.classList.add("form-box", "form-box-busqueda");
    let section_header = document.createElement("section");
    tempDiv.insertAdjacentElement("afterbegin", section_header);
    ...
    tempDiv.insertAdjacentElement("beforeend", section_body);
